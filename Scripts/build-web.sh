...
mkdir ../build/web
mkdir ../build/web/meshes
mkdir ../build/web/sprites
mkdir ../build/web/a3d
mkdir ../build/web/fonts
...
cp ../fonts/* ../build/web/fonts/
cp ../meshes/* ../build/web/meshes/
cp ../sprites/* ../build/web/sprites/
cp ../a3d/* ../build/web/a3d/
...
emrun --no_browser --port 8888 index.html
